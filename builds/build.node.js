...
function momentumScroll(dataObj) {
    ...
    if (!(0,_utils__WEBPACK_IMPORTED_MODULE_0__.isCompatible)()) {
    ...
    function onScroll(e) {
        ...
        easeFrames(lastLocation, pl, startStamp, (position) => {
            ...
            if (Array.isArray(activeOffsets)) {
                for (let i = 0; i < activeOffsets.length; i++) {
                    let e = Object.assign({}, _defaults__WEBPACK_IMPORTED_MODULE_1__.defaultSpeeds, activeOffsets[i]);
            ...
            if (Array.isArray(activeFixedOffsets)) {
                for (let i = 0; i < activeFixedOffsets.length; i++) {
                    ...
                    let node = (0,_utils__WEBPACK_IMPORTED_MODULE_0__.selectNode)(activeFixedOffsets[i], true);
        ...
        if (dataObj.onScroll)
            asyncScrollFunction(e);
    }
    // Run dataObj.onScroll function asynchrounously
    function asyncScrollFunction(e) {
...
exports.slickScroll = __webpack_exports__;
/******/ })()
;

...
export class defaults {
    ...
    public defaults: { root: any, duration: number, easing: string, offsets: any[], fixedOffsets: any[] } = {
        root: "body",
        duration: 1000,
    ...
    public defaultSpeeds: { speedY: number, speedX: number } = {
        speedY: 1,
        speedX: 1
    }

    // Default pennerEasings
    public pennerEasing: { name: string, value: number[] } [] = [
        // Sine

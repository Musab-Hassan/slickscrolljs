...
import { momentumScrollStruct } from "./momentumScroll/struct"
import { defaults } from "./momentumScroll/defaults";
...
export default class slickScroll {
    ...
    // Default properties
    private defaults = new defaults().defaults;
    private defaultSpeeds = new defaults().defaultSpeeds;
    private pennerEasing = new defaults().pennerEasing;

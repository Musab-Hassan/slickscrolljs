...
// Prevent variables other than slickScroll from being globally accessed
(function() {
    ...
    slickScroll = {
        momentumScroll: function(dataObj) {
            ...
            function onScroll(e) {
                ...
                function easeFrames(tl, pl, startStamp, onIterate) {
                    ...
                    function parseBezier(bezierString) {
                        let vals = presetEasings.filter(e => e.name == bezierString);
                        if (vals[0]) {
                            vals = vals[0].value;
                        } else {
            ...
            function addOffset(obj) {
                ...
                var find = offsets[dataObj.root].find(i => i.element == obj.element);
